...
**Tech stack:** .NET 10 · ASP.NET Core minimal API · `Azure.AI.DocumentIntelligence` (Layout → Markdown) · OpenXML (XLSX typed cells) · Azure OpenAI Foundry utility model (image description) · OTel + Serilog · Docker → GHCR → AKS.
